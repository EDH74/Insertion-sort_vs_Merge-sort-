...
Na primeira versão do código, a execução estava rápida demais porque eu simplesmente não estava gerando os dados, então o programa estava comparando um array de tamanho 1 para cada entrada.
